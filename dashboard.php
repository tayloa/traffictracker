    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-auto">
        <select id="inputDate" class="form-control">
          ...
          <option data-toggle="modal" data-target="#inputDateRange">Custom Date Range</option>
        </select>
      </div>
      ...
      <div class="modal-body">
        <form>
          <div class="form-group">
            ...
            <div class="value"><input type="text" size="10" maxlength="10" value="" name="dob" id="dob"/> <em>yyyy-mm-dd</em></div>
            <p>to</p>
            <div class="value"><input type="text" size="10" maxlength="10" value="" name="dob" id="dob"/> <em>yyyy-mm-dd</em></div>
